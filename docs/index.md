...
!!! tip "Aide Discord"
    ...
    Pour une aide concerant les étapes à réaliser en *français*, vous pourrez trouver votre bonheur sur le [serveur Discord dédié](https://discord.gg/EKuDvDFe).
...
!!! tip ""
    ...
    Homebrew peut être exécuté gratuitement sur votre Switch via un CFW tant que vous avez un système de «première génération», avec une version logicielle de 11.0.1 ou moins, et un câble USB-C.
